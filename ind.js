        var token = "90938297|-31949273667670399|90952278";
        var dbName = "StudentDB";
        var relName = "StudentDB-Rel"
        resetForm()
        ...
        function checkrecord() {
            ...
            var getReqStr = createGET_BY_KEYRequest("90938297|-31949273667670399|90952278", "StudentDB", "StudentDB-Rel", jsonStr, true, true);
            jQuery.ajaxSetup({ async: false });
        ...
        function RegisterStudent() {
            ...
            // var putReqStr=createUPDATERecordRequest(, jsonStr, "StudentDB", "StudentDB-Rel",localStorage.getItem("rec_no"));
            jQuery.ajaxSetup({ async: false });
            var resultObj = executeCommandAtGivenBaseUrl(putReqStr, "http://api.login2explore.com:5577", "/api/iml");
            if (resultObj.status == 200) {
